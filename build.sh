...
$MEX CXX=$COMPILER -I/usr/local/include mPAPI_enumPresetEvents.cpp -L/usr/local/lib/ -lpapi -output $OUT_DIR/mPAPI_enumPresetEvents -outdir $OUT_DIR
$MEX CXX=$COMPILER -I/usr/local/include mPAPI_enumNativeEvents.cpp -L/usr/local/lib/ -lpapi -output $OUT_DIR/mPAPI_enumNativeEvents -outdir $OUT_DIR
